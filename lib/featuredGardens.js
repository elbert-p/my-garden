 ...
 *  • Optional `columns` sets how many tiles a section fits per row on wide
 *    screens; omit it to use the default. Narrow screens always show fewer.
 *
...
export const FEATURED_SECTIONS = [
  {
    ...
    gardenIds: [
      'd885a625-939d-4fe7-b793-b254b66ec60b', //mark
  ...
  },
  {
    ...
    gardenIds: [
      ...
      '445e1bbd-9005-4c9b-a67a-fc333f54ebb6', //Lake Avenue
      '0f903fd6-4082-4176-9c8f-0157ee510935', //clark david
    ...
    gardenIds: [
      ...
      '067f05c4-4685-46a5-8c21-e11a6bb79df1', //Peirce
